export default {
  ...
  email: {
    ...
    Dear: "Dear",
    ThanksForRequesting: "Thank you for requesting a YOGO demo",
    ConfirmYourEmail: "In order to create the demo, we just need to confirm your email",
    GetStartedWithYogo: "Please click this link to confirm your email and to get started with YOGO",
    YourYogoDemoReady: "Your YOGO demo is ready",
    PleaseAllowIntroduction: "Please allow us to give a short introduction to the various parts of YOGO.",
    CanLogWithiEmailPassword: "You can log into every module with your email and your password.",
    AdminModule: "The admin module",
    WhereKeepTrack: "This is where you keep track of everything.",
    CustomersClassesEtc: "Your customers, classes, memberships, etc, etc, etc.",
    CustomerModule: "The customer module",
    WhereBuyRegister: "This is where your customers buy your memberships and register for your classes.",
    WebsiteWidget: "The website widgets",
    ModulesEasilyEmbeded: "These modules can be easily embedded in your own website.",
    WayYourCustomers: "That way your customers will feel that they stay inside your universe when they sign up, buy memberships, etc.",
    TeacherModule: "The teacher module",
    WhereYourTeachers: "This is where your teachers have an overview of their classes and the people who are attending.",
    AlsoWhereStartLiveStream: "It is also where they start the livestream for online classes.",
    CheckinModule: "The check-in module",
    CanRunOnTablet: "This module can run on a tablet in your studio if you would like your customers to check themselves in upon arrival.",
    NativeApp: "The native APP",
    YogoNativeApp: "The YOGO native app (add-on) is an app for iOS and Android, branded with your logo and colors.",
  },
  system: {
